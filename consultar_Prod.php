	...
	<body>
		<form action="" class="form-horizontal" method="POST" name="form">
			...
			<div class="form-group" align="middle">		
				<input type="submit" value="EXCLUIR" class="btn btn-danger" onClick="ExecutaAcao('exclui_Prod');">
				<input type="submit" value="ALTERAR" class="btn btn-info" onClick="ExecutaAcao('alterar_Prod');">	
